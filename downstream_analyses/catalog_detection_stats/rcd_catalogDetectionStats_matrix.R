...
{	for(typ in t)
	{	options(scipen = 999)
		infile<-paste("stats/",spec,".MergedTargetRegions.proportionDetected_perTissue",sep="")
		...
		{	
			outfile<-paste("plots/",spec,".MergedTargetRegions.percDetectedRegions.marix.tiff",sep="")
