...
# CHANGELOG:
# Changes in relation to make_introns.awk
# - modified by TM to generate introns compatible with recount data by modifying coords: start+1 and end-1
